...
export const Action: React.FC<Props> = ({ widgetName, onClick }) => {
  return <div className="bg-black pt-5 px-4 sm:pt-5 sm:px-6 sm:mt-auto sm:ml-[7%] lg:flex lg:items-center lg:justify-between lg:gap-x-2 lg:py-6 lg:px-7">
    ...
    <Button className="mt-5 w-[calc(100%_+_32px)] -ml-4 sm:w-[calc(100%_+_48px)] sm:-ml-6 lg:w-fit lg:h-fit lg:m-0" onClick={onClick}>Попробовать бесплатно</Button>
  </div>
};